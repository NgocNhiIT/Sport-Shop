	...
	<content>
			...
			<div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
	  			<div class="carousel-inner" role="listbox">
	    			<div class="item active">
	      				<img class="img-responsive" src="images/featured/page2.jpg">
	    			</div>
	    			<div class="item">
						<img class="img-responsive" src="images/featured/page3.jpg">
	    			</div>
					<div class="item">
						<img class="img-responsive" src="images/featured/page1.jpg">
	    			</div>
	  			</div>
		...
		<div class="main-block container">
			...
			<div class="categories-content col-lg-3 col-md-3 col-sm-6 col-xs-12">
				...
				<p class="price"><span><?php echo number_format($product['Gia']); ?>Đ</span> - <span class="discount">$<?php echo $product['GiamGia']; ?></span></p>
				<?php           
