<?php
  ...
  $target_file   = $target_dir . basename($_FILES["hinh_nhomsp"]["name"]);
  ...
  if(isset($_POST["submit"])) {
      ...
      $check = getimagesize($_FILES["hinh_nhomsp"]["tmp_name"]);
      if($check !== false)
      {
  ...
  if ($_FILES["hinh_nhomsp"]["size"] > $maxfilesize)
  {
  ...
  if ($allowUpload)
  {
      ...
      {
          echo "File ". basename( $_FILES["hinh_nhomsp"]["name"]).
